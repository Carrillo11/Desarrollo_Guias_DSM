...
import sv.udb.edu.guia090app.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    private ApiService getApiService() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://dog.ceo/api/breed/")   //https://dog.ceo/api/breed/hound/images/random
    ...
    private void searchByName(String raza) {
        ...
        batch.enqueue(new Callback<DogsResponse>() {
            ...
            @Override
            public void onResponse(@Nullable Call<DogsResponse> call, @Nullable Response<DogsResponse> response) {
